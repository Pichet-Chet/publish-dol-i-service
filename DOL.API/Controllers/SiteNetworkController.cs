...
namespace DOL.API.Controllers
{
    ...
    [ApiController]
    //[Authorize]
    public class SiteNetworkController : ControllerBase
    {
        private readonly ISiteNetworkRepo repoCollection;

        public SiteNetworkController()
        {
            this.repoCollection = new SiteNetworkRepo();
        }

        // GET: api/values
        [HttpGet]
        public async Task<IActionResult> Get([FromQuery] SiteNetworkFilter param)
        {
        ...
        [HttpGet]
        [Route("workActive")]
        public async Task<IActionResult> WorkActive(int id)
        {
            Response result = new Response();
            ...
            try
            {
                ...
                result = await Task.Run(() => repoCollection.WorkActive(id));
        ...
        [HttpGet]
        [Route("repairActive")]
        public async Task<IActionResult> RepairActive(int SiteId)
        {
            Response result = new Response();
            ...
            try
            {
                ...
                result = await Task.Run(() => repoCollection.repairActive(SiteId));
        ...
        // POST api/values
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] SiteNetwork param)
        {
            Response result = new Response();
        ...
        // PUT api/values/5
        [HttpPatch]
        public async Task<IActionResult> Update([FromBody] SiteNetwork param)
        {
            Response result = new Response();
