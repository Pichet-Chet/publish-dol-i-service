...
{
	public class SysStatusValidation
    {
        ...
        public static Response NameTh(string Input)
        {
            Response resp = new Response();
        ...
        public static Response NameEn(string Input)
        {
            Response resp = new Response();
        ...
        public static Response Category(string Input)
        {
            Response resp = new Response();
        ...
        public static Response NameThLenght(int Lenght)
        {
            Response resp = new Response();
        ...
        public static Response NameEnLenght(int Lenght)
        {
            Response resp = new Response();
        ...
        public static Response CategoryLenght(int Lenght)
        {
            Response resp = new Response();
